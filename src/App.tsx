        ...
        <div>
          ...
          <Reveal delay={0.2}>
            <p className="font-body text-[17px] lg:text-[19px] text-ink-muted leading-[1.65] max-w-[480px] mb-9">
              Расписание, заметки, оплата и&nbsp;аналитика для&nbsp;специалистов
              в&nbsp;частной практике. Перестаньте переключаться
              между пятью приложениями.
            </p>
          </Reveal>
...
function PainSection() {
  const pains = [
    ...
    },
    {
      ...
      desc: "Заметки после каждой сессии, ручная запись клиентов, напоминания, чеки. Время, которое могло уйти на клиентов.",
    },
    {
      icon: UserX,
      title: "Отмены без предупреждения",
      desc: "Арендовали кабинет, подготовились — а клиент не пришёл. Ни напоминания, ни политики отмены.",
    },
    {
      icon: Wallet,
      title: "Финансовый хаос",
      desc: "Сколько заработали за месяц? Какая загрузка? До лимита самозанятого далеко? Без таблиц — не посчитать.",
    },
  ];
...
function FeaturesSection() {
  const features = [
    ...
    },
    {
      ...
      desc: "Готовые шаблоны под вашу специальность. Структура вместо хаоса — откройте заметки к&nbsp;любому клиенту через год.",
      priority: "must",
    },
    {
      icon: CreditCard,
      title: "Оплата без «переведите на Сбер»",
      desc: "Клиент платит по ссылке. Автоматические чеки для самозанятых. Вы&nbsp;занимаетесь работой, а&nbsp;не&nbsp;бухгалтерией.",
      priority: "must",
    },
    {
      icon: MessageCircle,
      title: "Работает там, где ваши клиенты",
      desc: "Запись, напоминания, оплата — всё в&nbsp;Telegram. Клиентам не&nbsp;нужно скачивать новое приложение.",
      priority: "must",
    },
    {
      icon: Video,
      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
        <Reveal>
          ...
          <h2 className="font-display font-semibold text-[34px] lg:text-[48px] leading-[1.12] tracking-[-0.01em] text-ink mb-4">
            Замените 5 приложений одним
          </h2>
          <p className="font-body text-[17px] text-ink-muted leading-relaxed mb-16 max-w-[500px]">
            Всё что нужно для ведения частной практики — запись клиентов, заметки,
            оплата, аналитика. В&nbsp;одной рабочей среде.
          </p>
        </Reveal>
...
function ForWhomSection() {
  const segments = [
    ...
    },
    {
      ...
      label: "",
      desc: "Расписание, оплата, трекинг сессий. Всё для структурированной практики — без десяти вкладок.",
      accent: "terracotta",
    },
    {
      icon: Apple,
      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
        <Reveal>
          ...
          <p className="font-body text-[17px] text-ink-muted leading-relaxed mb-16 max-w-[480px]">
            Для любого специалиста, который работает с&nbsp;клиентами один
            на&nbsp;один и&nbsp;устал от&nbsp;зоопарка приложений.
          </p>
        </Reveal>
  ...
  const rows = [
    {
      ...
      us: "0% комиссия, ваши клиенты — ваши",
    },
    {
      label: "Зоопарк",
...
function SecuritySection() {
  const points = [
    { icon: Shield, title: "152-ФЗ", desc: "Полное соответствие закону о персональных данных" },
          ...
          <Reveal>
            <div>
              ...
              <p className="font-body text-[16px] text-sage-light/70 leading-[1.65] max-w-[420px]">
                Данные ваших клиентов хранятся на российских серверах и&nbsp;защищены
                шифрованием. Раздельные согласия на&nbsp;обработку данных для каждого клиента.
              </p>
            </div>
          </Reveal>
      ...
      <div className="max-w-[900px] mx-auto px-6 lg:px-8">
        <Reveal>
          ...
          <p className="font-body text-[17px] text-ink-muted leading-relaxed mb-14 max-w-[420px]">
            Начните бесплатно. Перейдите на&nbsp;Pro, когда практика вырастет.
            Дешевле одной сессии.
          </p>
        </Reveal>
      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8 relative z-10">
        ...
        <Reveal delay={0.1}>
          <p className="font-body text-[17px] text-ink-muted leading-relaxed mb-9 max-w-[440px]">
            Начните бесплатно — до 15 клиентов, без ограничения по времени.
